...
namespace SoundBanks_Editor
{
    public partial class Frm_EffectProperties : Form
    {
        ...
        public Frm_EffectProperties(EXSound SoundToCheck, string SoundName, ProjectFile FileProperties, string v_HashcodesSFX, string v_HashcodesSFXData, Dictionary<string, string> v_SFX_Defines, Dictionary<string, string> v_SB_Defines, Dictionary<string, double[]> v_SFX_Data, string ParentID, ResourceManager v_ResourcesManager)
        {
            InitializeComponent();
        ...
        {
            //Sound Data defines
            if (GenericFunctions.FileIsModified(Hashcodes.HT_SoundsDataMD5, HashcodesSFXData))
            {
                Hashcodes.LoadSoundDataFile(HashcodesSFXData, SFX_Data, SFX_Defines, ResourcesManager);
            }

            //Sound defines
            if (GenericFunctions.FileIsModified(Hashcodes.HT_SoundsMD5, HashcodesSFX))
            {
