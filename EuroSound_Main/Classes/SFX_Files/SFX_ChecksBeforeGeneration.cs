    ...
    internal class SFX_ChecksBeforeGeneration
    {
        internal bool ValidateMarkers(List<EXStreamMarker> MarkersList, string ObjectName, IList<string> Reports)
        {
            ...
            for (int i = 0; i < MarkersList.Count; i++)
            {
                ...
                {
                    case (int)Enumerations.EXMarkerType.Start:
                        StartMarkers++;
                        break;
                    case (int)Enumerations.EXMarkerType.End:
                        EndMarkers++;
                        break;
                    case (int)Enumerations.EXMarkerType.Goto:
                        GotoMarkers++;
                        break;
                    case (int)Enumerations.EXMarkerType.Loop:
                        LoopMarkers++;
                        break;
                }
            }
